...
void getSectorByCoordinates(float &x, float &y)
{
    ...
    if (x > 0 && y < 0)
    {
        ...
        if (Radius > 2)
        {
            if (y > sqrtFunc)
                res = 3;
            else if (y < sqrtFunc && y > straightLine)
                res = 2;
            else if (y < straightLine && y > quadraticParabol)
                res = 1;
            else if (y < quadraticParabol)
                res = 11;
        }
        // 19, 20, 21, 22, 12
        else
        {
            if (y > straightLine && y > sqrtFunc)
                res = 19;
            else if (y < straightLine && y > sqrtFunc)
                res = 20;
            else if (y > sqrtFunc && y < straightLine)
                res = 22;
            else if (y < sqrtFunc && y < straightLine && y > quadraticParabol)
                res = 21;
            else if (y < quadraticParabol)
                res = 12;
        }
    ...
    cout << "Заданная точка лежит в " << res << " секторе" << endl
